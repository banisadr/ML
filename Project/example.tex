...
\icmltitlerunning{Schulman, Banisadr}

\begin{document} 

\twocolumn[
\icmltitle{Sentiment Classification of Social Media Interactions - Project Status Report}

% It is OKAY to include author information, even for blind
% submissions: the style file will automatically remove it for you
% unless you've provided the [accepted] option to the icml2014
% package.
\icmlauthor{Matt Schulman}{schmatt@wharton.upenn.edu}
\icmlauthor{Bahram Banisadr}{bahram@wharton.upenn.edu}
...
\subsection{Data Processing and Feature Generation}
